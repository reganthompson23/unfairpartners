            ...
            <div className="p-6">
              ...
              {order.notes && (
                <div className="bg-zinc-800 border border-zinc-700 rounded p-3 mb-4">
                  <p className="text-sm text-zinc-400">
                    <span className="text-zinc-500 font-medium">Notes:</span> {order.notes}
                  </p>
                </div>
              )}
              ...
              <div className="flex gap-2 mb-4">
                <select
                  ...
                  className="px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-zinc-600"
                >
